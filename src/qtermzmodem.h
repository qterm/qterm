#ifndef QTERMZMODEM_H
#define QTERMZMODEM_H
...
static uchar zeros[4] = {0, 0, 0, 0} ;

static char hexChars[] = "0123456789abcdef" ;

static uchar AckStr[1] = {ACK} ;
static uchar NakStr[1] = {NAK} ;
...
//Member Function
    ...
    int ZXmitHdr(int type, int format, uchar data[4], ZModem *info) ;
    int ZXmitHdrHex(int type, uchar data[4], ZModem *info) ;
    int ZXmitHdrBin(int type, uchar data[4], ZModem *info) ;
    int ZXmitHdrBin32(int type, uchar data[4], ZModem *info) ;
