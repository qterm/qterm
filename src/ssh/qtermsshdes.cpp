...
void SSH1DES3::decrypt(const u_char * source, u_char * dest, int len)
{
...
void SSH1DES3::encrypt(const u_char * source, u_char * dest, int len)
{
...
void SSH1DES3::setIV(const u_char * data)
{
	memset(d_IV1, 0, sizeof(d_IV1));
	memset(d_IV2, 0, sizeof(d_IV2));
	memset(d_IV3, 0, sizeof(d_IV3));
...
void SSH1DES3::setKey(const u_char * data)
{
	DES_cblock key;
